<?php
if ( ! class_exists( 'lsvr_cta_block' ) ) {
class lsvr_cta_block extends lsvr_block {
    ...
    function __construct() {
        ...
        parent::__construct( 'lsvr_cta_block', $block_options );
    ...
    function form( $instance ) {
        ...
        <div class="lsvr-form-container">
            ...
            <div class="lsvr-form-row">
                <label for="<?php echo $this->get_field_id( 'html_content' ) ?>"><?php _e( 'Message', 'lsvr-toolkit' ); ?></label>
                <div class="lsvr-form-field">
            ...
            <div class="lsvr-form-row">
                <label for="<?php echo $this->get_field_id( 'link' ) ?>"><?php _e( 'Button Link', 'lsvr-toolkit' ); ?></label>
                <div class="lsvr-form-field">
    ...
    function block( $instance ) {
        ...
        echo do_shortcode( '[lsvr_cta_message title="' . $title . '" button_label="' . $button_label . '" link="' . $link . '" inview_anim="' . $inview_anim . '" custom_class="' . $custom_class . '"]' . lsvr_field_editor_output( $html_content ) . '[/lsvr_cta_message]' );
